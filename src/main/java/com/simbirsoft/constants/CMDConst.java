...
public final class CMDConst {
    ...
    public static final String ROOM_DISCONNECT = "disconnect";
    public static final String ROOM_CREATE_PARAMETER_PRIVATE = "-c";
    ...
    public static final String BAN_PARAMETER_LOGIN = "-l";
    public static final String BAN_PARAMETER_MINUTES = "-m";
}